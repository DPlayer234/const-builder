...
- `#[builder(default = ...)]` accepts any Rust expression, however when a string literal is provided, it is parsed again. To specify defaults for `&str` fields, wrap them in parenthesis: `#[builder(default = ("default value"))]`
